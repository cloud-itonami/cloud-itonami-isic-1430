# Operator Quickstart — Community Knitwear Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 1430** (`cloud-itonami-isic-1430`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1430.git
cd cloud-itonami-isic-1430
```
...
- Blueprint governor key: `knitwear-governor`
- Likely source path: `knitwear.governor.cljc`
