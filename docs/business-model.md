# Business Model: Community Knitwear Manufacturing
...
## Classification
- Repository: `cloud-itonami-isic-1430` ([github.com/cloud-itonami/cloud-itonami-isic-1430](https://github.com/cloud-itonami/cloud-itonami-isic-1430))
- ISIC Rev.5: `1430` — Community Knitwear Manufacturing
- Domain: `:knitwear/manufacturing`
- Social impact: :fair-labor :local-industry :supply-chain-transparency
- Actor: `:knitwear-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :knitwear/manufacturing — who wants
...
One managed tenant (:knitwear/manufacturing):
...
- Do not bypass the `:knitwear-governor` for production decisions.
